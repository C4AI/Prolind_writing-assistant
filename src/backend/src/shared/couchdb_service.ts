...
class CouchDBService {
    ...
    constructor(couchdbUrl: string) {
        this.couchdbUrl = couchdbUrl;
    }

    async getDocument(getDocumentParams: any): Promise<any> {
        try {
    ...
    async postDocument(postDocumentParams: any): Promise<any> {
        try {
            const service = Nano(this.couchdbUrl)
    ...
    async putDocument(putDocumentParams: any): Promise<any> {
        try {
            const service = Nano(this.couchdbUrl)
    ...
    async getAttachment(getAttachmentParams: any): Promise<any> {
        try {
            const service = Nano(this.couchdbUrl)
    ...
    async deleteDocument(deleteDocumentParams: any): Promise<any> {
        try {
            const service = Nano(this.couchdbUrl)
    ...
    async postFind(postFindParams: any): Promise<any> {
        try {
            const service = Nano(this.couchdbUrl)
