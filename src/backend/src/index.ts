  ...
  try {
    service
      ...
      .then((response) => {
        ...
        const translatorUrl =
          response.result["languages"]["Nheengatu"]["services"]["translator"];
        const nextWordUrl =
          response.result["languages"]["Nheengatu"]["services"]["next_word"];
        const spellCheckerUrl =
          response.result["languages"]["Nheengatu"]["services"][
            "spell_checker"
          ];

        const translationModel =
          response.result["languages"]["Nheengatu"]["translation_model"];
