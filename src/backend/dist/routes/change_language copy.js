...
import { service } from "../shared/cloudante_service.js";
export const changeLanguage = async (req, res) => {
    let language = req.body.language;
    let orthography = req.body.ortography;
    ...
    if (!data.languages[language] ||
        ...
        res.status(400);
        res.statusMessage = "Ortografia ou língua inválida";
        res.send();
    }
    try {
        ...
        document["users"][req.body.username]["orthography"] = orthography;
...
//# sourceMappingURL=change_language%20copy.js.map